...
%image_read_loop.FunctionArgs.EndLoop.Value=(TrackStruct.StartFrame+TrackStruc
%t.FrameCount-1)*TrackStruct.FrameStep;
%image_read_loop.FunctionArgs.IncrementLoop.Value=TrackStruct.FrameStep;
%image_read_loop.FunctionArgs.MatchingGroups.Value=[];
%image_read_loop.FunctionArgs.MatchingGroups.FunctionInstance='IfIsEmptyPrevio
%usCellsLabel';
%image_read_loop.FunctionArgs.MatchingGroups.OutputArg='MatchingGroups';
%image_read_loop.FunctionArgs.Tracks.FunctionInstance='IfIsEmptyPreviousCellsL
%abel';
%image_read_loop.FunctionArgs.Tracks.OutputArg='Tracks';
%image_read_loop.FunctionArgs.Tracks.Value=[];
%image_read_loop.KeepValues.Tracks.FunctionInstance='IfIsEmptyPreviousCellsLab
%el';
%image_read_loop.KeepValues.Tracks.OutputArg='Tracks';
%image_read_loop.KeepValues.MatchingGroups.FunctionInstance='IfIsEmptyPrevious
%CellsLabel';
...
%display_curtrackframe_function.FunctionArgs.Variable.FunctionInstance='Segmen
%tationLoop';
%display_curtrackframe_function.FunctionArgs.Variable.OutputArg='LoopCounter';
%display_curtrackframe_function.FunctionArgs.VariableName.Value='Current
%Tracking Frame';
%image_read_loop_functions=addToFunctionChain(image_read_loop_functions,displa
%y_curtrackframe_function);
%…
