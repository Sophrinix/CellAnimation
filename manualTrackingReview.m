...
%
%Errors in mitotic event detection can be corrected using the "Add Split"
%and "Remove Split"
...
%selection layers GUI to apply the layer. To delete a layer click on
%"Manage Selection Layers"
