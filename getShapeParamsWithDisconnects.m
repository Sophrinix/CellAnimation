...
%Usage
%This module is used to extract the shape parameters (Area,Eccentricity,etc.) of objects
%in a label matrix. The difference between this module and getShapeParams is that
%getShapeParamsWithDisconnects supports objects which are disjoint (spread across multiple
